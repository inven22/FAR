...
<section class="content">
    ...
    @endif
    <form method="post" action="{{URL::to('/update_custumer/'.$edit->id)}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="inputnama_penyewa">Nama penyewa</label>
                            <input
                                type="text"
                                id="inputName"
                                name="nama_penyewa"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                value="{{ $edit->alamat }}"
                                required="required"
                                autocomplete="email">{{  $edit->alamat  }}</textarea>
                            @error('alamat')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
