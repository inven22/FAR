...
<section class="content">
    ...
    @endif
    <form method="post" action="{{URL::to('/insert_custumer')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Tambah data penyewa</h3>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('nam_penyewa') }}"
                                required="required"
                                autocomplete="nama_penyewa">
                            @error('name')
                        ...
                        <div class="form-group">
                            <label for="inputEmail">Email penyewa</label>
                            <input
                                type="email"
                                id="inputEmail"
                                name="email"
            ...
            <div class="col-md-6">
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="password">No hp penyewa</label>
                            <input
                                id="no_hp"
                                type="number"
                                placeholder="No hp"
